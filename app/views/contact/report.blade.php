...
<div class="contact-us form-container">
    ...
    {{ FormField::custom(['type'=>'text','name'=>'offender','label'=>t('master.persontoreport').':','placeholder'=>'Name of the person to report',
                                                'value'=>Input::old('offender')]) }}
    {{ FormField::custom(['type'=>'text','name'=>'group','placeholder'=>t('master.group'),'label'=>t('master.group').':',
                                                'value'=>Input::old('group')]) }}
