                                ...
                                <td width="700">
                                    <table width="700" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        ...
                                        <tr>
                                            ...
                                            <img src="http://app.onaroll21.com/images/header-shadow.jpg" width="698" height="34">
                                            </td>
                                            <td width="1" bgcolor="#dadada" style="background-color:#dadada"></td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <tbody><tr>
                                                        ...
                                                        <td width="610" align="left">
                                                            ...
                                                            <div style="margin:10px 15px 0px 2px;font-family:Verdana,sans-serif;color:#444444;font-size:14px;line-height:1.5em">
                                                                ...
                                                                If you're not using the app already you can download from the store

                                                                <br>

                                                                <p>
                                                                    <a target="_blank" href="http://app.onaroll21.com"><img style="border-style: none; border: 0;" src="http://www.onaroll21.com/images/google-btn.png" alt="LOGIN"></a>
                                                                    <a target="_blank" href="http://app.onaroll21.com"><img style="border-style: none; border: 0;" src="http://www.onaroll21.com/images/apple-btn2.png" alt="LOGIN"></a>
                                ...
                                <td style="padding:20px 20px 10px 20px">
                                    ...
                                    <div style="font-family:Verdana,sans-serif;font-size:10px;line-height:1.4em;color:#888888">
                                        ...
                                        This email belongs to On A Roll 21&trade; is governed by the Terms &amp; Conditions agreed to on registration, including disclaimers and limitations of liability.<br/><br/>
                                          ...
                                          <a href="http://app.onaroll21.com/api/email/unsubscribe/{{$detail['email']}}">Unsubscribe</a>
                                          </div>
                                    </div>
                                </td>
                            </tr>
