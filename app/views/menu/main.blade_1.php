...
<!--            <li><a href="/" data-toggle="tooltip" data-placement="bottom" title="{{ trans('menu.home') }}"><i class="fa fa-home fa-lg"></i></a></li>-->
            ...
            <li>
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="/admin/site">{{ trans('menu.sitesettings') }}</a></li>
